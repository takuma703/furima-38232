  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordが半角数字のみのときに登録できないこと' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Password は半角英数文字のみでその両方を含む入力が必要です')
      end
      ...
      it 'first_nameが半角のときに登録できないこと' do
      ...
      it 'familt_nameが半角のときに登録できないこと' do
      ...
      it 'first_name_kanaは半角と漢字、ひらがなでは登録できないこと' do
      ...
      it 'family_name_kanaは半角と漢字、ひらがなでは登録できないこと' do
